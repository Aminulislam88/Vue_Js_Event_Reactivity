            ...
            <div class="w-3/4 mx-auto rounded border">
                <div class="bg-white p-10 shadow-sm">
                    ...
                    <div class="transition hover:bg-indigo-50" v-for="(accordion,index) in accordions " :key="index" >
                        <!-- header -->
                        <div @click="accordion.isOpen=!accordion.isOpen" class="accordion-header cursor-pointer transition flex space-x-5 px-5 items-center h-16" ><i class="fas fa-plus" ></i>
        ...
        <div class="w-full p-10 bg-gradient-to-br from-pink-50 to-indigo-100 grid place-items-center">
            <div class="w-3/4 mx-auto rounded border">
                <div class="bg-white p-10 shadow-sm">
                    ...
                    <p class="text-sm font-light text-gray-600 my-3"> The accordion is a graphical control element comprising a vertically stacked list of items such as labels or thumbnails </p>
                    <div class="h-1 w-full mx-auto border-b my-5"></div><!-- What is term -->
                    <div class="transition hover:bg-indigo-50" v-for="(accordion,index) in accordions"><!-- header -->
                        <div @click="activeIndex=index" class="accordion-header cursor-pointer transition flex space-x-5 px-5 items-center h-16"><i class="fas fa-plus"></i>
                            <h3>{{accordion.heading}}</h3>
                        </div><!-- Content -->
